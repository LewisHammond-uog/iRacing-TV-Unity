...
public class OverlayBattleChyron : MonoBehaviour
{
	...
	public void Update()
	{
		enable.SetActive(!LiveData.Instance.isLiveSessionReplay && !LiveData.Instance.HasAnyCustomActive() && LiveData.Instance.liveDataControlPanel.masterOn && LiveData.Instance.liveDataControlPanel.battleChyronOn && LiveData.Instance.liveDataBattleChyron.show && !LiveData.Instance.liveDataIntro.show && !LiveData.Instance.liveDataRaceResult.show && ipc.isConnected && LiveData.Instance.isConnected );
